...
import { ArrowRight, CheckCircle, Zap, BarChart3, Trophy, Users, Star, DollarSign } from 'lucide-react';
    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="bg-[#09091a] border-b border-[#1c1c3a] py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="flex items-center gap-2 px-7 py-3.5 bg-gradient-to-r from-[#8b5cf6] to-[#7c3aed] text-black font-bold rounded-xl hover:opacity-90 transition-opacity">
              Create Startup Profile <ArrowRight size={18} />
            </button>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-[#0f2010] to-[#10200f] border border-[#4ade80]/20 rounded-3xl p-10">
            ...
            <Link to="/impact" className="inline-flex items-center gap-2 px-6 py-3 bg-[#4ade80] text-black font-semibold rounded-xl hover:bg-[#22c55e] transition-colors">
      ...
      <section className="py-20 bg-[#09091a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button className="flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[#8b5cf6] to-[#7c3aed] text-black font-bold rounded-xl hover:opacity-90 transition-opacity text-lg mx-auto">
            Create Your Startup Profile <ArrowRight size={20} />
          </button>
        </div>
      </section>
    </div>
